...
# echo "Pulling image..."
docker pull 756471705399.dkr.ecr.us-east-1.amazonaws.com/algopioneer:v1.9.5
...
docker run -d \
  ...
  -v /home/ec2-user/pairs_config.json:/app/pairs_config.json:ro \
  -v /home/ec2-user/paper_trades_alpaca.csv:/app/paper_trades_alpaca.csv \
  756471705399.dkr.ecr.us-east-1.amazonaws.com/algopioneer:v1.9.5 \
  portfolio \
  --config /app/pairs_config.json \
  --exchange alpaca \
  --paper
