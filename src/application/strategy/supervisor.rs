...
use crate::application::strategy::{LiveStrategy, MarketData, StrategyInput};
use dashmap::DashMap;
...
pub struct StrategySupervisor {
    ...
    risk_engine: Arc<crate::application::risk::DailyRiskEngine>,
...
impl StrategySupervisor {
    ...
    pub fn new() -> Self {
        Self {
            ...
            risk_engine: Arc::new(crate::application::risk::DailyRiskEngine::with_defaults()),
    ...
    #[must_use]
    pub fn with_risk_config(mut self, config: crate::application::risk::DailyRiskConfig) -> Self {
        self.risk_engine = Arc::new(crate::application::risk::DailyRiskEngine::new(config));
        self
    }
