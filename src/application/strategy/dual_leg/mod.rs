...
pub use crate::domain::types::{MarketData, OrderSide};
// Re-export Executor from exchange for backward compatibility
pub use crate::application::ports::exchange::Executor;
...
impl From<crate::domain::exchange::ExchangeError> for ExecutionError {
    fn from(e: crate::domain::exchange::ExchangeError) -> Self {
        use crate::domain::exchange::ExchangeError as EE;
        match e {
...
pub use crate::infrastructure::logging::throttle::{DualLegLogThrottler, LogThrottle};
...
// --- Domain Models ---
// MarketData is now imported from crate::domain::types

// --- AS2: Market Data Validation ---
// Validators moved to validators.rs
pub use crate::domain::validation::validators::{
...
// Executor trait is now imported from crate::infrastructure::exchange
...
impl DualLegStrategy {
    ...
    pub fn with_state_store(
        mut self,
        store: std::sync::Arc<dyn crate::infrastructure::logging::StateStore>,
    ...
    fn to_position_state_record(
        ...
        Some(crate::infrastructure::logging::PositionStateRecord {
...
use crate::application::strategy::{LiveStrategy, StrategyInput};
        ...
        ) -> Result<crate::domain::orders::OrderId, crate::domain::exchange::ExchangeError>
        {
            ...
            *count += 1;
            ...
            if *self.should_fail.lock().await {
                return Err(crate::domain::exchange::ExchangeError::Other(
