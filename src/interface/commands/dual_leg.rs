...
pub async fn run_dual_leg_trading(
    ...
    leg2_id: &str,
    env: AppEnv,
    exchange_id: crate::domain::exchange::ExchangeId,
    ...
    let _exchange_config = crate::infrastructure::exchange::ExchangeConfig::from_env(exchange_id)?;
    ...
    if exchange_id == crate::domain::exchange::ExchangeId::Kraken {
    ...
    let risk_engine = Arc::new(crate::application::risk::DailyRiskEngine::new(risk_config));
    ...
    let (entry_strategy, risk_monitor) = match strategy_type {
        "basis" => {
            ...
            (
                manager as Box<dyn crate::application::strategy::dual_leg::EntryStrategy>,
                monitor,
            )
        }
        "pairs" => {
